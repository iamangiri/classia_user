...
class _CamsCreationScreenState extends State<CamsCreationScreen> with TickerProviderStateMixin {
  ...
  late AnimationController _animationController;
  late Animation<double> _fadeAnimation;
  String? _canNumber; // Store CAN number
  bool _isCheckingCanStatus = true; // Track initial CAN status check
  ...
  String? _occupation;
  String? _pep;
  String? _resIsd; // Added for ISD code
  String? _resStd; // Added for STD code
  ...
  void initState() {
    ...
    _checkCanStatus(); // Check CAN status on init
    _animationController.forward();
  }
  ...
  Future<void> _submitForm() async {
    setState(() => _isLoading = true);
      ...
      if (response['status'] == true) {
        ...
        // Launch NOM_VER_LINK_H1 if available
        ...
        // Update CAN number and refresh UI
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  setState(() => _canNumber = null); // Allow re-creation
                  _animationController.forward();
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.buttonBackground,
  ...
  Widget _buildPersonalDetails() {
    return Column(
      children: [
        ...
        SizedBox(height: 16.h),
        _buildDropdownField(
          label: 'Residence ISD Code',
          value: _resIsd,
          items: isdOptions,
          icon: Icons.phone_outlined,
          onChanged: (value) => setState(() => _resIsd = value),
        ),
        SizedBox(height: 16.h),
        _buildTextField(
          controller: _emailController,
        ...
        _buildTextField(
          ...
          hint: 'Enter your city of birth',
          icon: Icons.location_city_outlined,
          validator: (value) => value!.isEmpty ? 'Please enter your birth city' : null,
        ),
        SizedBox(height: 16.h),
        _buildDropdownField(
          label: 'Birth Country',
  ...
  Widget _buildAddressDetails() {
    return Column(
      children: [
        ...
        SizedBox(height: 16.h),
        _buildTextField(
          controller: TextEditingController(text: _resStd),
          label: 'STD Code',
          hint: 'Enter STD code (e.g., 0612)',
          icon: Icons.dialpad_outlined,
          keyboardType: TextInputType.number,
          validator: (value) => value!.isEmpty ? 'Please enter STD code' : null,
          onChanged: (value) => setState(() => _resStd = value),
        ),
      ],
    );
  }
    ...
    return Column(
      children: [
        _buildTextField(
          ...
          hint: 'Enter nominee name',
          icon: Icons.person_add_outlined,
          validator: (value) => value!.isEmpty ? 'Please enter nominee name' : null,
        ),
        SizedBox(height: 16.h),
        _buildTextField(
          controller: _nomineeDobController,
        ...
        _buildTextField(
          ...
          hint: 'Enter nominee PAN or ID number',
          icon: Icons.credit_card_outlined,
          validator: (value) => value!.isEmpty ? 'Please enter nominee PAN/ID' : null,
        ),
        SizedBox(height: 16.h),
        _buildTextField(
          controller: _nomineeMobileController,
        ...
        _buildTextField(
          ...
          hint: 'Enter nominee address line 1',
          icon: Icons.home_outlined,
          validator: (value) => value!.isEmpty ? 'Please enter nominee address line 1' : null,
        ),
        SizedBox(height: 16.h),
        _buildTextField(
          controller: _nomineeAddr2Controller,
        ...
        _buildTextField(
          ...
          hint: 'Enter nominee city',
          icon: Icons.location_city_outlined,
          validator: (value) => value!.isEmpty ? 'Please enter nominee city' : null,
        ),
        SizedBox(height: 16.h),
        _buildTextField(
          controller: _nomineePincodeController,
