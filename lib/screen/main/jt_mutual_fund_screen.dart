...
class JtMutualFundScreen extends StatefulWidget {
  const JtMutualFundScreen({super.key});

  @override
  _JtMutualFundScreenState createState() => _JtMutualFundScreenState();
}

class _JtMutualFundScreenState extends State<JtMutualFundScreen> with TickerProviderStateMixin {
