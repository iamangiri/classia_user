...
// import 'dart:ui';
// import '../../themes/app_colors.dart';
// import '../../widget/common_app_bar.dart'; // Assuming this is your custom app bar
// import '../../service/apiservice/market_service.dart'; // For fetching NAV data
//
// class FundDetailsScreen extends StatefulWidget {
//   final Map<String, dynamic> fund;
//
...
// }
//
// class _FundDetailsScreenState extends State<FundDetailsScreen> with TickerProviderStateMixin {
//   int _selectedTab = 0;
//   final List<String> _tabs = ['Overview', 'Performance', 'Fund Manager', 'Holdings', 'Documents'];
//   late AnimationController _animationController;
//   late Animation<double> _fadeAnimation;
...
//   late Animation<double> _disclaimerFadeAnimation;
//
//   // State variables for NAV data and time period selection
//   Map<String, dynamic>? fundDetails;
//   List<Map<String, dynamic>> navHistory = [];
...
//   }
//
//   /// Fetches fund details from the API using the scheme code
//   Future<void> _fetchFundDetails() async {
//     try {
//       final marketService = MarketService();
//       final details = await marketService.fetchFundDetails(widget.fund['schemeCode']);
//       setState(() {
//         fundDetails = details;
//         _parseNavHistory();
//       });
...
//   }
//
//   /// Parses NAV history into a list of maps with DateTime and double values
//   void _parseNavHistory() {
//     if (fundDetails != null && fundDetails!['navHistory'] != null) {
//       navHistory = (fundDetails!['navHistory'] as List)
//           .map((item) => {
//         'date': parseDate(item['date']),
//         'nav': double.parse(item['nav'].toString()),
//       })
//           .toList();
//       // Sort by date ascending
//       navHistory.sort((a, b) => a['date'].compareTo(b['date']));
//     }
//   }
//
//   /// Converts date string from "dd-MM-yyyy" to DateTime
...
//   }
//
//   /// Determines the start date for filtering NAV data based on selected period
//   DateTime getStartDate(String period) {
//     if (navHistory.isEmpty) return DateTime.now();
//     final latestDate = navHistory.last['date'];
//     switch (period) {
//       case '7 Days':
//         return latestDate.subtract(Duration(days: 7));
//       case '1 Month':
//         return latestDate.subtract(Duration(days: 30));
//       case '3 Months':
//         return latestDate.subtract(Duration(days: 90));
//       case '1 Year':
//         return latestDate.subtract(Duration(days: 365));
//       case '3 Years':
//         return latestDate.subtract(Duration(days: 365 * 3));
//       case '5 Years':
//         return latestDate.subtract(Duration(days: 365 * 5));
//       case 'All Time':
//       default:
...
//   }
//
//   /// Enhanced Performance tab with NAV line graph and time period selector
//   Widget _buildModernPerformanceTab() {
//     if (navHistory.isEmpty) {
//       return Center(child: Text('No NAV data available'));
//     }
//
//     final startDate = getStartDate(selectedPeriod);
//     final filteredNavHistory = navHistory
//         .where((item) => item['date'].isAfter(startDate) || item['date'].isAtSameMomentAs(startDate))
//         .toList();
//
//     if (filteredNavHistory.isEmpty) {
//       return Center(child: Text('No data for selected period'));
//     }
//
//     final spots = filteredNavHistory.asMap().entries.map((entry) {
...
//                     color: selectedPeriod == period ? Colors.white : AppColors.primaryText,
//                   ),
//                 ),
//               );
//             }).toList(),
...
//                     showTitles: true,
//                     interval: (filteredNavHistory.length / 5).ceil().toDouble(),
//                     getTitlesWidget: (value, meta) {
//                       final index = value.toInt();
//                       if (index >= 0 && index < filteredNavHistory.length) {
//                         final date = filteredNavHistory[index]['date'];
//                         return Text(
//                           '${date.day}/${date.month}',
...
//                     show: true,
//                     color: (AppColors.primaryGold ?? Colors.amber).withOpacity(0.2),
//                   ),
//                 ),
//               ],
...
//                       final date = filteredNavHistory[spot.x.toInt()]['date'];
//                       final nav = spot.y;
